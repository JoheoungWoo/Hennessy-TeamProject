      ...
      <div class="main_area">
		<div id="board_area" class="jsx-2303464893 editor">
			<form method="post" action="boardAction.jsp" enctype="multipart/form-data">
				...
				<div>
					<img style="width: 50px; display: none;" id="preview-image" src="https://dummyimage.com/50x50/ffffff/000000.png&text=preview+image">
    				<input style="display: block;" name="b_file" type="file" id="input-image">
    			</div>
				<div id="b_send">
					<button type="submit" id="savebutton" name="b_send"><img src="image/but07.png"></button>
				</div>
			</form>
		</div>
      </div>
