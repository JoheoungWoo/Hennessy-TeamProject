...
<body>
	<% 
		...
		if (session.getAttribute("userID") != null) {
			...
			userID = ""; // 비로그인시 오류 발생으로 인한 문자열 처리
		}
		int pageNumber = 1;
	...
	%>
	<div>
		<a href="postPage.jsp"><input type="button" value="돌아가기" style="margin-top:30px;"></a>
		<div id="c">
			...
			<div id="b" style="height:auto;">
				content :<br><br> 
				<% if(getFileName != null) { %>
				<img src="<%= b_fullpath %>" alt="<%= b_fullpath %>" width="auto" height="auto"></img><br>
				<% } %>
				<%= getContent %>
				<br><br>
			</div>
			...
			<% if (getUserId != null && (getUserId.equals(userID) || userID.equals("관리자"))) { %>
			<a href="board_update.jsp?boardID=<%= getBoardId %>"><input type="button" value="수정하기"></a>
	...
	<div id="a">
		...
		<% 
			...
			<div id="b" style="margin-bottom:5px; height:auto;">
				...
				<img src="<%= c_fullpath %>" alt="<%= c_fullpath %>" width="auto" height="auto"></img><br>
				<%= comment %>
